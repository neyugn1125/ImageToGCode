...
export const translations = {
  vi: {
    ...
    cutterOffsetD: "Mã bù bán kính dao (D)",
    cutterCompMode: "Bù bán kính dao (Phương pháp bù)",
    compCAM: "CAM tự bù (Khuyên dùng - Chuẩn kích thước)",
    compG41: "G41 (Máy CNC tự bù - Trái / Phay thuận)",
    compG42: "G42 (Máy CNC tự bù - Phải / Phay nghịch)",
    compG40: "G40 (Tắt bù - Chạy tâm nét vẽ danh nghĩa)",
    programNum: "Số thứ tự chương trình (O)",

    // Các nút chức năng
    btnGenerate: "Xuất chương trình G-Code",
    btnReset: "Khôi phục thông số chuẩn",
    btnQuickCopyGcode: "Sao chép nhanh G-Code",
  ...
  en: {
    ...
    cutterOffsetD: "Radius Offset Code (D)",
    cutterCompMode: "Cutter Compensation Method",
    compCAM: "CAM Direct Offset (Recommended - Exact Size)",
    compG41: "G41 (CNC Controller Left / Climb)",
    compG42: "G42 (CNC Controller Right / Conventional)",
    compG40: "G40 (Off - Nominal Centerline)",
    programNum: "Program Number (O)",

    // Action buttons
    btnGenerate: "Generate G-Code Program",
    btnReset: "Reset Parameters",
    btnQuickCopyGcode: "Quick Copy G-Code",
